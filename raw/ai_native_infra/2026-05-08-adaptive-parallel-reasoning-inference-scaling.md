...
slug: 2026-05-08-adaptive-parallel-reasoning-inference-scaling
fetched_at: 2026-05-09T15:44:21.658Z
aihot_id: ""
aihot_url: ""
...
aihot_starred: 0
aihot_summary: |
  自适应并行推理（Adaptive Parallel Reasoning, APR）是一种新范式，让 LLM 自主决定何时分解任务、并行处理多少子任务以及如何协调结果。针对序列推理中因探索路径增长导致的延迟与"context-rot"问题，近期研究如 ThreadWeaver 与 Multiverse 通过动态控制并行线程，在数学与代码推理基准上取得显著性能提升并大幅降延迟。这标志着从固定并行策略到自适应智能控制的范式转变。
...
ingest_source: "daily 2026-05-09 · 技巧与观点 #7"
wiki_status: drafted
wiki_target: "wiki/AI基础设施/自适应并行推理-APR.md"
---
...
Disclosure: this post is part landscape survey, part perspective on adaptive parallel reasoning. One of the authors (Tony Lian) co-led ThreadWeaver ([Lian et al., 2025](https://doi.org/10.48550/arXiv.2512.07843)), one of the methods discussed below. The authors aim to present each approach on its own terms.
...
![Figure 6: RadixAttention’s KV Cache Management Strategy](https://bair.berkeley.edu/static/blog/adaptive-parallel-reasoning/figure-06-radix.png)  
...
![Figure 7: KV Cache “Stitching” During Multiverse Inference](https://bair.berkeley.edu/static/blog/adaptive-parallel-reasoning/figure-07-kv-stitch.png)  
...
![Figure 8: Multiverse’s Attention Mask](https://bair.berkeley.edu/static/blog/adaptive-parallel-reasoning/figure-08-attention-mask.png)  
...
![Figure 9: ThreadWeaver’s Prefill and Decode Strategy](https://bair.berkeley.edu/static/blog/adaptive-parallel-reasoning/figure-09-prefill-decode.png)  
...
We thank [Nicholas Tomlin](https://nickatomlin.github.io/) and [Alane Suhr](https://www.alanesuhr.com/) for providing us with helpful feedback. We thank Christopher Park, Karl Vilhelmsson, [Nyx Iskandar](https://xyntechx.com/), Georgia Zhou, [Kaival Shah](https://www.kaivalshah.com/), and Jyoti Rani for their insightful suggestions. We thank [Vijay Kethana](https://www.vkethana.com/), [Jaewon Chang](https://www.jaewon.io/), [Cameron Jordan](https://www.cameronsjordan.com/), [Syrielle Montariol](https://smontariol.github.io/), Erran Li, and [Anya Ji](https://anya-ji.github.io/) for their valuable discussions. We thank [Jiayi Pan](https://jiayipan.com/), [Xiuyu Li](https://xiuyuli.com/), and [Alex Zhang](https://alexzhang13.github.io/) for their constructive correspondences about Adaptive Parallel Reasoning and Recursive Language Models.
